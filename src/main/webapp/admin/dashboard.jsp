...
<div class="dashboard-container">
    ...
    <div class="card-grid">
        <a href="${pageContext.request.contextPath}/user/profile" class="dashboard-card">
            <i class="bi bi-people-fill"></i><h5>My Profile</h5>
        </a>

        <a href="${pageContext.request.contextPath}/rooms" class="dashboard-card">
            <i class="bi bi-house-door"></i><h5>Room Management</h5>
        </a>

        <a href="${pageContext.request.contextPath}/students" class="dashboard-card">
            <i class="bi bi-person-lines-fill"></i><h5>Student Management</h5>
        </a>

        <a href="${pageContext.request.contextPath}/fees" class="dashboard-card">
            <i class="bi bi-cash-coin"></i><h5>Fees & Payments</h5>
        </a>

        <a href="${pageContext.request.contextPath}/complaints" class="dashboard-card">
            <i class="bi bi-exclamation-circle"></i><h5>Complaints</h5>
        </a>
        ...
        <a href="${pageContext.request.contextPath}/visitors" class="dashboard-card">
            <i class="bi bi-people"></i><h5>Visitor Logs</h5>
        </a>

        <a href="${pageContext.request.contextPath}/reports" class="dashboard-card">
            <i class="bi bi-bar-chart-line"></i><h5>Reports</h5>
        </a>
    </div>
</div>
</body>
